...
3.  Review background on [introductory probability and statistics](activities/Stats_review.qmd) ([solutions to exercises](activities/Stats_review_soln.qmd))
...
-   [Self-Guided Activity](activities/data-wrangling.qmd)
-   Datasets:
...
-   [Lecture Slides](lectures/VB_LinMods.pdf), [Lecture Video 1](https://www.youtube.com/watch?v=oqjzfXDgZY0&list=PLrMhLVyZEsORr81gXrfgiq2vX30_brtpF&index=2), [Lecture Video 2](https://www.youtube.com/watch?v=-VelMqc9z6M&list=PLrMhLVyZEsORr81gXrfgiq2vX30_brtpF&index=1), [Practical](activities/VB_Linear_models_activity.qmd)
-   Datasets:
    -   [Genome Size](data/GenomeSize.csv)
    -   [Huxley et al Trait Data](data/traitdata_Huxleyetal_2021.csv)
